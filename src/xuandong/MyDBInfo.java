...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108kaichieh";
	public static final String MYSQL_PASSWORD = "mPQMmjwxwxdX7Q8T";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_kaichieh";
