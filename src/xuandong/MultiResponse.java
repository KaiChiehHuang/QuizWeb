...
public class MultiResponse extends Problem {
	...
	public String getInsertSQL() {
		...
		String sql = "INSERT INTO " + Problem.problemType.get(type) + " VALUES(\"" + this.questionID + "\",\"" + this.question + "\",\"" + answer + "\"," + count + "\",\"" + ordered + "\");";
		return sql;
	}
	...
	public String getUpdateSQL() {
		String answer = getArrayToString(answers);
		String sql = "UPDATE " + Problem.problemType.get(type) + " SET Question = \"" + this.question + "\" , Answer = \"" + answer + "\", Count = " + count + " , Ordered = " + ordered + " WHERE QuestionID = \"" + this.questionID + "\";";
		return sql;
	}
}
