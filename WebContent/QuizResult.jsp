...
<body style="height:150px;background-size:100%;background-color:#fffff6;">
...
<div class="container" style = "position: relative; width:70%; top: 50px;">
  <h2 style="text-align:center; position: relative;  top: 100px;">Your score is <% out.println(score); %></h2>
  <h2 style="text-align:center; position: relative;  top: 100px;">You took <% out.println(duration); %> to finish this quiz</h2>
  <h3 style="text-align:center; position: relative;  top: 150px;">Your Past Performance</h3> 
