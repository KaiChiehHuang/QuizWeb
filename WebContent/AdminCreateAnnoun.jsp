...
<div
		...
		<div
			...
			<div
				...
				<a href="AdminDeleteUser.jsp"><h4 style="color: #ffb3b3;">QuizzGo</h4></a>
			</div>
		</div>
...
<div class = "container">
	<div>
		<p><h5>Subject: </h5> </p>
		<input style = "width:72%" type="text" class="form-control form-control-inline" name = "announsubject" placeholder="Subject">
	</div>
	<div>
		<p><h5>Content: </h5> </p>
  		<textarea style = "width:72%" class="form-control" rows="8" name = "announce" placeholder="Announcement Content"></textarea>
  	</div>
  	<div style = "position: relative; width:100%; top: 20px;">
  	<button type="submit" class="btn btn-success" style="position: relative; left:35%; width:80px; margin-left:-40px">Create</button>
	</div>
</div>
<div  style = "position: relative; width:100%; top: 100px;"><a href="AdminDeleteUser.jsp"> Back to Admin Page </a></div>
</div>
</form>
</body>
</html>
