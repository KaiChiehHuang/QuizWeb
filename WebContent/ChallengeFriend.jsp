		...
		<form action="ChallengeFriendServlet" method="post">
			<div class="input-group" style="opacity: 0.95;">
				...
				<% 
						...
						out.print("<input type=\"text\" class=\"form-control\" placeholder=\"Choose a quiz...\"aria-describedby=\"basic-addon1\" value=\""+quizName+"\">");
				%>
			...
			<div class="input-group" style="opacity: 0.95;">
				...
				<input type="text" class="form-control" placeholder="Who you want to challenge?"
					aria-describedby="basic-addon1" name="receiverID">
			</div>
			<br>
			<br>
			<div style="text-align: right">
				<input type="submit" class="btn btn-warning" value="Send Challenge"></input>
			</div>
			<hr style="border: none; border-top: 1px #CCCCCC solid; height: 1px;">
			<div style="text-align: center">
				<p>Changed your mind?</p>
				<a href="UserViewHistory.jsp">Back to your quiz history</a>
			</div>
		</form>
	</div>
